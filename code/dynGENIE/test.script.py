...
#for x in range(exp_data.shape[0]-1):
...
#(VIM, alphas, prediction_score, stability_score, treeEstimators) = dynGENIE3(trans_exp_data, arab_time_points)
pd.DataFrame(VIM).to_csv('test_VIM.csv')
pd.DataFrame(alphas).to_csv('test_alphas.csv')
#print(alphas)
print(prediction_score)
print(stability_score)
#print(treeEstimators)
#print(exp_data[33])
